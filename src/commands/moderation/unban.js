// Archivo: src/commands/moderation/unban.js
...
module.exports = {
    ...
    async execute(interaction, client) {
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.BanMembers)) {
            return interaction.reply({ content: '❌ No tienes permisos para desbanear miembros.', ephemeral: true });
        }
        ...
        try {
            ...
            await interaction.reply({ content: '❌ No se pudo desbanear al usuario o no se encuentra en la lista de baneos.', ephemeral: true });
        }
    }
};
