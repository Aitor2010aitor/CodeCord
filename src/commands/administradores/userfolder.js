// Archivo: src/commands/administradores/userfolder.js
...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!hasPerm) {
            return interaction.reply({ content: '❌ Necesitas permisos de administrador o "Gestionar el servidor" para usar este comando.', flags: MessageFlags.Ephemeral });
        }

        await interaction.reply({ content: '⏳ Generando archivo TXT con el listado de usuarios de CodeCord...', flags: MessageFlags.Ephemeral });
